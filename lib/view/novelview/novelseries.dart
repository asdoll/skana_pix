      ...
      () => Scaffold(
        ...
        body: Obx(() {
          if (controller.loadingState.value == LoadingState.loading &&
              controller.novelSeriesDetail.value == null) {
              ...
              if (controller.novelSeriesDetail.value != null)
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      SelectionArea(
                        child: Text(controller.novelSeriesDetail.value!.title)
                            .header(),
                      ).paddingAll(16),
                      SelectionArea(
                        child: Padding(
                    ...
                    Padding(
                      ...
                      child: SizedBox(
                        ...
                        child: filledButton(
                            onPressed: () {
                              Get.to(() =>
                                  NovelViewerPage(controller.last.value!));
                            },
              ...
              FlutterSliverList(
                delegate: SliverChildBuilderDelegate((context, index) {
                  if (index == controller.novels.length) {
                    if (controller.loadingState.value != LoadingState.loading &&
                        controller.loadingState.value != LoadingState.noMore) {
                              ...
                              child: Row(
                                ...
                                children: [
                                  Icon(
                                    ...
                                    size: 12,
                                    color: context
                                        .moonTheme?.tokens.colors.piccolo,
                                  ),
                                  const SizedBox(
                                    width: 2,
                                  ),
