...
class _NewVersionPageState extends State<NewVersionPage> {
  ...
  void initState() {
    super.initState();
    updateController.check(showResult: false);
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: GetX<UpdateController>(
          builder: (_) => updateController.loadingState.value ==
                  ...
                  children: [
                    ...
                    Row(
                      ...
                      children: [
                        filledButton(
                            onPressed: () async {
                              await updateController.check(showResult: true);
                            },
