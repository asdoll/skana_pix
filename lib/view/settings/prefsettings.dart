        ...
        slivers: [
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Select<String>(
                ...
                children: [
                  SelectItemButton(value: 'system', child: Text("System".tr)),
          ...
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Select<String>(
                ...
                onChanged: (value) => controller.changeLanguage(value),
                children: [
                  SelectItemButton(value: 'illust', child: Text('Illust'.tr)),
          ...
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.showOriginal.value, onChanged: controller.setShowOriginal)
            )),
          ),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.hideR18.value, onChanged: controller.setHideR18)
            )),
          ),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.hideAI.value, onChanged: controller.setHideAI)
            )),
          ),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.feedAIBadge.value, onChanged: controller.setAIBadge)
            )),
          ),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.longPressSaveConfirm.value, onChanged: controller.setLongPressConfirm)
            )),
          ),
          Divider(),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.novelDirectEntry.value, onChanged: controller.setNovelDirectEntry)
            )),
          ),
          Divider(),
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.checkUpdate.value, onChanged: controller.setCheckUpdate)
            )),
          ),
          ...
          SliverToBoxAdapter(
            child: Card(
              ...
              trailing: Switch(value: controller.isHighRefreshRate.value, onChanged: controller.setHighRefreshRate)
            )),
          ),
        ],
      ),)
